...
export const Footer = () => {
  return (
    <div className="mt-12 flex items-center justify-between border-t border-gray-300 pt-8 font-['Poppins'] text-gray-800 dark:border-slate-600 dark:text-gray-400">
